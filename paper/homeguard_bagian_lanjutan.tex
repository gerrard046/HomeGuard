...
\begin{figure}[ht]
    \centering
    % Ganti dengan gambar diagram bila tersedia.
    \fbox{\parbox{0.92\linewidth}{\centering
    \textbf{[1] Network Discovery} $\rightarrow$
    \textbf{[2] Port Scanning} $\rightarrow$ \\
    \textbf{[3] Service Detection} $\rightarrow$
    \textbf{[4] OWASP Mapping \& Risk Scoring}}}
...
dengan temuan Neshenko \textit{et al.}~[8] bahwa mayoritas eksploitasi IoT
